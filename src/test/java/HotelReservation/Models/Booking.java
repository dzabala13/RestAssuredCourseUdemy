...
public class Booking  {
    ...
    // this object doesn't be intializate because it use another POJO, we just need to import the class if the object
    // Bookingdates are in another package in the project
